...
EsyUiPanel = (function() {
  ...
  EsyUiPanel.prototype.render = function() {
    var values;
    values = [this.window.paddingLeft, this.window.paddingTop, this.window.width, 60];
...
EsyUiRow = (function() {
  function EsyUiRow(panel, data) {
    this.panel = panel;
    this.data = data;
    this.currentPanel = this.panel.element;
    this.height = 30;
    this.width = 100;
    this.paddingLeft = 10;
    this.paddingTop = this.panel.window.paddingTop + 10;
    this.xOffset = this.currentPanel.margins[0];
    this.yOffset = this.currentPanel.margins[1] + this.panel.yOffset;
    this.render();
    return this.panel;
  }
  ...
  EsyUiRow.prototype.render = function() {
    ...
    this.currentPanel.size[1] += this.height;
    return this;
  };
